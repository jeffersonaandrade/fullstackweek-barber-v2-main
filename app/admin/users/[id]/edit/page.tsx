...
export default function EditUser() {
  ...
  // Carregar dados do usuário e barbearias
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Buscar barbearias (se necessário)
        if (user.role === 'receptionist') {
          const barbershopsResponse = await fetch("/api/admin/barbershops")
          if (barbershopsResponse.ok) {
            const barbershopsData = await barbershopsResponse.json()
